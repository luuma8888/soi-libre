...
async def run():
 report={'version':'3.0.0','checks':[],'sizes':[],'performance':[],'environment':{'platform':platform.platform(),'chromium':subprocess.check_output(['chromium','--version'],text=True).strip()}}
