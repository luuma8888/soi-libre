...
const APP_PATH = path.join(ROOT, "creations/boussolepro/boussole-pro-refonte.html");
const CLASSIC_PATH = path.join(ROOT, "creations/boussolepro/boussole-pro.html");
...
const branch = process.env.BOUSSOLE_REFONTE_BRANCH || "refonte/interface-v1";
...
| Nouveau HTML | OK | \`creations/boussolepro/boussole-pro-refonte.html\` ; ${appHtml.length} octets ; \`${sha256(appHtml)}\` |
...
await cp(APP_PATH, path.join(DELIVERY_DIR, "app/boussole-pro-refonte.html"));
