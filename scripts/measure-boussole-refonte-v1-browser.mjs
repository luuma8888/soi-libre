...
const HTML_PATH = path.join(ROOT, "creations/boussolepro/boussole-pro-refonte.html");
...
try {
  ...
  const httpUrl = `http://127.0.0.1:${server.address().port}/creations/boussolepro/boussole-pro-refonte.html`;
...
async function startServer(root) {
  const server = createServer(async (request, response) => {
    try {
      ...
      const file = path.resolve(root, `.${pathname === "/" ? "/creations/boussolepro/boussole-pro-refonte.html" : pathname}`);
